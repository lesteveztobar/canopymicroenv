...
#
# LEGACY — not part of the active pipeline. Predates the LaElenita/MindoMirador/
# Saloya site split and the current 02_model production API
# (characterize_niches.R, run_colonization_onesite.R). Still hardcodes the old
# 5-site list (including the retired "MiradorMindo" name) and reads
# data/csv/combinedv3.csv directly. Kept for historical reference only — see
# README.md's Pipeline overview for the current pipeline.
